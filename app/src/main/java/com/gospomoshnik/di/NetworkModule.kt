    ...
    fun provideOkHttpClient(): OkHttpClient =
        OkHttpClient.Builder()
            ...
            .apply {
                ...
                // Доверие сертификату НУЦ Минцифры настроено декларативно
                // в res/xml/network_security_config.xml (см. AndroidManifest).
                // TLS-валидация при этом НЕ отключается — доверяем только
                // конкретному корневому сертификату, добавленному в res/raw.
            }
            .build()
